...
static void activate(GtkApplication *app, gpointer user_data) {
  ...
  g_signal_connect(buttonIdling, "clicked", G_CALLBACK(toggle_status), NULL);
  g_signal_connect(buttonProduction, "clicked", G_CALLBACK(toggle_status), NULL);
  g_signal_connect(buttonQueu, "clicked", G_CALLBACK(toggle_status), NULL);
